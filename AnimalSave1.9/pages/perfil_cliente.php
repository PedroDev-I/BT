    ...
    <div class="container py-5">
                ...
                <section>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>Rua Exemplo, 123 - Bairro Feliz, Cidade - Estado</td>
                                <td><button class="btn btn-info">Ver Detalhes</button></td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>Rua Sol, 456 - Bairro Solar, Cidade - Estado</td>
                                <td><button class="btn btn-info">Ver Detalhes</button></td>
                            </tr>
                        </tbody>
                    </table>
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#cadastrarEnderecoModal">Cadastrar Endereço</button>
                </section>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <section>
                    <h2>Meus Serviços</h2>
                    <!-- Tabela com os Serviços realizados ou pendentes -->
                    <table class="table">
                        <thead>
                            <tr>
                                <th>#</th>
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>Banho e Tosa - Fido</td>
                                <td>Pendente</td>
                                <td><button class="btn btn-info">Ver Detalhes</button></td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>Banho - Whiskers</td>
                                <td>Realizado</td>
                                <td><button class="btn btn-info">Ver Detalhes</button></td>
                            </tr>
                        </tbody>
        ...
        <div class="modal fade" id="cadastrarEnderecoModal" tabindex="-1" aria-labelledby="cadastrarEnderecoModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="cadastrarEnderecoModalLabel">Cadastrar Novo Endereço</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="enderecoEstado" required>
                            </div>
                            <button type="submit" class="btn btn-success">Cadastrar</button>
                        </form>
                    </div>
        ...
        <div class="modal fade" id="cadastrarServicoModal" tabindex="-1" aria-labelledby="cadastrarServicoModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="cadastrarServicoModalLabel">Cadastrar Novo Serviço</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form>
                            <div class="mb-3">
                                <label for="servicoNome" class="form-label">Serviço</label>
